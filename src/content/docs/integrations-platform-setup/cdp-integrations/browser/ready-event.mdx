---
title: Ready event in the EdgeTag browser SDK
sidebar:
  label: Ready event
description: Register a callback that runs on every EdgeTag tag initialization in the browser SDK, so your code always runs after the tag is ready.
---
