---
title: Ready event in the EdgeTag headless SDK
sidebar:
  label: Ready event
description: Register a callback that runs on every EdgeTag tag initialization in the headless SDK, so your code always runs after the tag is ready.
---
